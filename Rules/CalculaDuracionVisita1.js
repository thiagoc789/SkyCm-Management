export default function calculaDuracionVisita1(clientAPI){
    let dialogs = clientAPI.nativescript.uiDialogsModule;
    var HoraInicio = clientAPI.evaluateTargetPath('#Page:DetalleViisitaActiva/#Control:FC_HoraInicio/#Value');
    var HoraFin = clientAPI.evaluateTargetPath('#Page:DetalleViisitaActiva/#Control:FC_HoraFin/#Value');
