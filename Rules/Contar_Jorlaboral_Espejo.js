...
export default function ContarVisitasPorMes(clientAPI) {
 	...
 	return clientAPI.count('/SkyCM_V2/Services/SkyCM_V2.service', 'WORKDAY', "$filter=ESTADO eq 'INACTIVO' and PERNR_SCP eq '{{#Application/#ClientData/#Property:UserId}}' and MES eq '"+system_date()+"' and ANO eq '"+system_date1()+"' ").then((count1) => {
