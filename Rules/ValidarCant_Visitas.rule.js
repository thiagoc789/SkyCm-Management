 ...
 */export default function ValidarCant_Visitas(clientAPI){
	var result1 = 'PV';
	var result2 = 'SV';
			return clientAPI.count('/SkyCM_V2/Services/SkyCM_V2.service', 'HISTV', "$filter= ID_CAMP eq 'PV' and PERNR_SCP eq '{{#Application/#ClientData/#Property:UserId}}' and KUNNR eq '{{#Property:KUNNR}}'and MES eq '"+system_date()+"' and ANO eq '"+system_date1()+"' ").then((count) => {
